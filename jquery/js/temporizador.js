(function($) {
    $.fn.temporizador = function(opcoes) {
        ...
        const novoDigito = () => $('<span class="digito">').html('0')

        const horaDezena = novoDigito()
        const horaUnidade = novoDigito()
        const minutoDezena = novoDigito()
        const minutoUnidade = novoDigito()
        const segundoDezena = novoDigito()
        const segundoUnidade = novoDigito()
